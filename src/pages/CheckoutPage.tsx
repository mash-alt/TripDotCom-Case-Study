...
export default function CheckoutPage() {
  ...
  const state = location.state as { hotel: Hotel; room: Room; checkIn: string; checkOut: string } | null;
  ...
  const { hotel, room, checkIn, checkOut } = state;
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-4 pt-24">
          <motion.div 
            ...
            className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl max-w-lg w-full text-center border border-gray-100"
          >
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            <p className="text-gray-500 font-medium mb-8">
              Thank you, {formData.firstName}. Your reservation at <strong>{hotel.name}</strong> is confirmed. A receipt has been sent to {formData.email}.
            </p>
            <div className="bg-gray-50 rounded-2xl p-6 mb-8 text-left space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Confirmation #</span>
                <span className="font-bold text-gray-900">TRIP-{Math.random().toString(36).substring(2, 8).toUpperCase()}</span>
              </div>
              <div className="flex justify-between text-sm">
            ...
            <button 
              onClick={() => navigate('/')} 
              className="w-full bg-primary text-white font-bold py-4 rounded-xl hover:bg-primary-dark transition-colors shadow-lg shadow-blue-500/30"
            >
              Return to Home
            </button>
          </motion.div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 pt-28 pb-20">
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-500 hover:text-primary font-bold mb-8 transition-colors"
        >
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 space-y-8">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 font-medium focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all" 
                      placeholder="John" 
                    />
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                      required type="text" name="cardNumber" value={formData.cardNumber} onChange={handleInputChange}
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 font-medium focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all" 
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input 
                        required type="text" name="expiry" value={formData.expiry} onChange={handleInputChange}
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 font-medium focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all" 
                        placeholder="MM/YY" 
                        maxLength={5}
                      />
                    ...
                    <div>
                      ...
                      <input 
                        required type="text" name="cvc" value={formData.cvc} onChange={handleInputChange}
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 font-medium focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all" 
                        placeholder="123" 
                        maxLength={4}
                      />
              ...
              <button 
                ...
                className="w-full bg-primary text-white font-black py-5 rounded-2xl shadow-xl shadow-blue-500/30 hover:bg-primary-dark transition-all transform active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? 'Confirming Booking...' : `Confirm & Pay $${grandTotal}`}
              </button>
            </motion.form>
          </div>
          ...
          <div className="lg:w-1/3">
            <motion.div 
              ...
              className="sticky top-28 bg-white border border-gray-100 rounded-[2rem] p-6 shadow-xl"
            >
              <h3 className="text-lg font-bold text-gray-900 mb-6">Booking Details</h3>
              
              <div className="flex gap-4 mb-6">
                <img src={hotel.image} className="w-20 h-20 rounded-xl object-cover" alt="Hotel" referrerPolicy="no-referrer" />
                <div>
              ...
              <div className="space-y-4 border-t border-gray-100 pt-6 mb-6">
                <div className="flex bg-gray-50 rounded-xl p-3 items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-semibold">{checkIn} &rarr; {checkOut}</div>
                  </div>
                </div>
                <div className="flex bg-gray-50 rounded-xl p-3 items-center gap-3">
              ...
              <div className="border-t border-gray-100 pt-6 space-y-3 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold">${totalRoomPrice}</span>
                </div>
                <div className="flex justify-between text-sm">
              ...
              <div className="bg-green-50 rounded-xl p-4 flex items-start gap-3">
                ...
                <p className="text-xs font-semibold text-green-700 leading-relaxed">
                  Your payment details are protected with bank-level encryption. Safe and secure checkout.
                </p>
              </div>
            </motion.div>
          </div>
