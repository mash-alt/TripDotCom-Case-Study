...
import { Globe, ArrowLeft, Mail, Lock, User, Apple } from 'lucide-react';
        ...
        <div className="relative z-10 w-full max-w-xl px-12">
          ...
          >
            <h1 className="text-5xl font-black text-white mb-6 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-primary">with us today.</span>
            </h1>
            <p className="text-xl text-gray-300 font-medium leading-relaxed max-w-md">
              Create an account to unlock member-only deals, save your favorite destinations, and earn rewards on every booking.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 md:p-24 relative overflow-y-auto">
        ...
        >
          <div className="text-center lg:text-left mb-10">
            ...
            <p className="text-gray-500 font-medium">Join TripStay to get the best travel deals.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-primary text-white font-black py-4 rounded-2xl shadow-xl shadow-blue-500/30 hover:bg-primary-dark transition-all transform active:scale-[0.98] mt-6 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500 font-bold uppercase tracking-wider text-[10px]">Or sign up with</span>
              </div>
            </div>
