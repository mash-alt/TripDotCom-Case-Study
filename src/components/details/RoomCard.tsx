  ...
  return (
    ...
    >
      <div className="md:w-72 bg-gray-100 aspect-video md:aspect-auto flex items-center justify-center text-gray-400">
        <img
          src={room.imageUrl ?? 'https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&q=80&w=400'}
          alt={room.name}
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-4 text-sm text-gray-500 mb-6">
            <div className="flex items-center gap-1.5 font-medium">
              ...
              <span>{room.capacityAdults} Adults, {room.capacityChildren} Children</span>
            </div>
            <div className="flex items-center gap-1.5 font-medium">
