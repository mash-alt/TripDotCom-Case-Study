        ...
        <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-2">
            <div className="relative">
              ...
              <div className="flex items-center bg-gray-50 border border-gray-200 rounded-2xl p-3 transition-colors">
                ...
                <input
                  ...
                  className="bg-transparent text-gray-900 font-medium outline-none w-full"
                />
              </div>
            </div>
            <div className="relative">
